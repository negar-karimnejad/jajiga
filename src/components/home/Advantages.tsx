  ...
  return (
    <div className="relative mt-10 bg-white dark:bg-gray-900">
      <div className="container">
        ...
        >
          <SwiperSlide className="m-2 rounded-2xl shadow-md dark:shadow-gray-950">
            <div className="flex gap-5 rounded-2xl border bg-white p-4 dark:bg-gray-900">
              <svg
              ...
              <div>
                <h4 className="mb-2 font-vazirBold text-base dark:text-white">
                  رزرواسیون 24 ساعته
                </h4>
                <p className="whitespace-nowrap text-[10px] text-gray-500 dark:text-gray-400 sm:text-sm">
                  خدمات آنلاین در تمام روزهای هفته
                </p>
              </div>
            </div>
          </SwiperSlide>
