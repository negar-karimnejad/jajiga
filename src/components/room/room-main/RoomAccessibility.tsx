...
function RoomAccessibility() {
  ...
  return (
    <div
      className={`duration-400 sticky top-0 z-40 h-14 items-center justify-between rounded-b-lg bg-black/80 px-8 py-3 shadow-lg transition-all dark:bg-gray-950/90 max-md:hidden ${scrollYPosition > 400 ? 'flex' : 'hidden'}`}
    >
