    ...
    <>
      ...
      >
        <div
          ...
          className={`overflow-y-auto rounded-lg bg-gray-50 p-2 shadow transition-all duration-500 dark:bg-gray-800 dark:text-white max-md:w-full min-[600px]:w-[500px] ${isOpen ? 'max-h-[30rem] min-h-[25rem]' : 'h-0'}`}
        >
          <Button
        ...
        <div
          onClick={(e) => e.stopPropagation()}
          className={`absolute left-0 top-24 z-50 rounded-xl border bg-white shadow-lg shadow-gray-500 ${isShowCalendar ? 'visible opacity-100' : 'invisible opacity-0'}`}
        >
