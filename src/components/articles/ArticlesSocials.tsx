  ...
  return (
    <div className="flex items-center gap-2">
      <Link
        ...
        className="flex h-[40px] w-[40px] items-center justify-center rounded-full border-2 border-gray-800 dark:border-gray-100 dark:text-gray-100 hover:opacity-50 transition-all"
      >
