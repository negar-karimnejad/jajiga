        ...
        <div className="flex max-w-4xl flex-col items-center justify-center gap-20">
          <div className="container">
            ...
            <p className="text-sm leading-6 text-gray-700 dark:text-gray-300">
              وقتی هر یک از دوستان دعوت شده، در جاجیگا رزرو کنند یا میزبان شوند
              به تناسب مبلغ اولین رزرو ایشان، به شما تا 2۰۰ هزار تومان اعتبار
              هدیه اعطا می‌شود که می‌توانید در رزروهای بعدی خود هزینه کنید.
            </p>
          </div>
