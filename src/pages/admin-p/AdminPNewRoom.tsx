...
const SigninSchema = Yup.object().shape({
  ...
  reserved: Yup.string().required('تعداد رزرو اقامتگاه را وارد کنید'),
  code: Yup.string().required('کد اقامتگاه را وارد کنید'),
  residence_type: Yup.string().required('نوع اقامتگاه را وارد کنید'),
  capacity: Yup.string().required('ظرفیت استاندارد اقامتگاه را وارد کنید'),
  max_capacity: Yup.string().required('حداکثر ظرفیت اقامتگاه را وارد کنید'),
  foundation_meterage: Yup.string().required(
    'متراژ زیربنا اقامتگاه را وارد کنید',
  ),
  area_meterage: Yup.string().required('متراژ محوطه اقامتگاه را وارد کنید'),
  bedroom: Yup.string().required('تعداد اتاق خواب اقامتگاه را وارد کنید'),
  price: Yup.string().required('نرخ هر شب اقامتگاه را وارد کنید'),
  max_stay: Yup.string().required('حداکثر اقامت را وارد کنید'),
  images: Yup.string().required('کاور اقامتگاه را آپلود کنید'),
});
