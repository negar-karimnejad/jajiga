...
function AdminPDashboard() {
  ...
  return (
    <div className="bg-gray-100 px-10 dark:bg-gray-900 max-md:col-span-12 md:col-span-9 lg:col-span-10">
      <h2 className="mt-10 mb-16 text-xl dark:text-white">
        <span className="font-vazirBold text-xl text-violet-500 dark:text-violet-400">
      ...
      <div className="my-5 rounded-md bg-white p-2 shadow-md dark:bg-gray-50 sm:p-10">
        ...
        <div className="mx-auto mt-5 flex w-fit items-center justify-center gap-1">
          <div
            ...
            className={`h-4 cursor-pointer rounded-full border-2 border-gray-700 transition-all duration-500 ${isActive === 'costs' ? 'w-10 bg-gray-700' : 'w-4 bg-transparent'}`}
          ></div>
          <div
            onClick={() => setIsActive('sales')}
            className={`h-4 cursor-pointer rounded-full border-2 border-gray-700 transition-all duration-500 ${isActive === 'sales' ? 'w-10 bg-gray-700' : 'w-4 bg-transparent'}`}
          ></div>
          <div
            onClick={() => setIsActive('incomes')}
            className={`h-4 cursor-pointer rounded-full border-2 border-gray-700 transition-all duration-500 ${isActive === 'incomes' ? 'w-10 bg-gray-700' : 'w-4 bg-transparent'}`}
          ></div>
        </div>
      </div>
    </div>
