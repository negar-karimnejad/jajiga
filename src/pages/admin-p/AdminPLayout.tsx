  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900">
      <div className="grid grid-cols-12 gap-5 px-5">
        ...
        <div
          className={`space-y-5 rounded-md transition-all duration-300 ease-linear dark:bg-gray-900 ${isPushMenu ? 'col-span-11' : 'col-span-12 md:col-span-7 lg:col-span-8 xl:col-span-9'}`}
        >
          <div className="fixed top-0 z-20 h-5 w-full bg-gray-100 dark:bg-gray-900"></div>
          <AdminHeader toggleMenu={toggleMenu} />
          <div className="container z-10 h-[100rem] rounded-md bg-gray-100 dark:bg-gray-800">
            <Outlet />
          </div>
        </div>
      </div>
