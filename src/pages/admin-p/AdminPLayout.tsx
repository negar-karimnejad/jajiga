  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900">
      <div className="grid grid-cols-12 gap-5 px-5">
        <div
          className={`transition-all duration-500 ease-in-out ${isPushMenu ? 'col-span-1 mx-auto' : 'md:col-span-5 lg:col-span-4 xl:col-span-3'}`}
        >
          <AdminSidebar isPushMenu={isPushMenu} />
        </div>
        <div
          className={`transition-all duration-500 ease-in-out space-y-5 rounded-md dark:bg-gray-900 ${isPushMenu ? 'col-span-11' : 'col-span-12 md:col-span-7 lg:col-span-8 xl:col-span-9'}`}
        >
